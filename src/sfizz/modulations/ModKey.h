...
public:
    ...
    static ModKey createCC(uint16_t cc, uint8_t curve, uint16_t smooth, float step, bool pernote=false);
    ...
    struct RawParameters {
        union {
            ...
            struct { uint16_t cc; uint8_t curve; uint16_t smooth; float step; bool pernote; };
